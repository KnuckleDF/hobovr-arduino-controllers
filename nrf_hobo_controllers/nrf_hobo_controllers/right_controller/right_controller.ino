...
void loop() {
  ...
  controller_state.qw = tempq[0];
  controller_state.qx = tempq[1];
  controller_state.qy = tempq[2];
  controller_state.qz = tempq[3];
  ...
  //radio.stopListening(); // needed before transmission
    ...
    //Serial.write( (char*)&controller_state, sizeof(controller_state) );
  //radio.startListening();
